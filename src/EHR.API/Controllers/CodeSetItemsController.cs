// EHR.API/Controllers/CodeSetItemsController.cs
...
namespace EHR.API.Controllers
{
    ...
    public class CodeSetItemsController : ControllerBase
    {
        private readonly ICodeSetItemService _service;

        public CodeSetItemsController(ICodeSetItemService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateCodeSetItemDto dto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] UpdateCodeSetItemDto dto)
        {
