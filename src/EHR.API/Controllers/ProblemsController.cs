// EHR.API/Controllers/ProblemsController.cs
...
namespace EHR.API.Controllers
{
    ...
    public class ProblemsController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateProblemDto dto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] UpdateProblemDto dto)
        {
