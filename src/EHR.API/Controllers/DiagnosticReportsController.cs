// EHR.API/Controllers/DiagnosticReportsController.cs
...
namespace EHR.API.Controllers
{
    ...
    {
        private readonly IDiagnosticReportService _service;

        public DiagnosticReportsController(IDiagnosticReportService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateDiagnosticReportDto dto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] UpdateDiagnosticReportDto dto)
        {
