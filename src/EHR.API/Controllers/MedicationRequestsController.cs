// EHR.API/Controllers/MedicationRequestsController.cs
...
namespace EHR.API.Controllers
{
    ...
    public class MedicationRequestsController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateMedicationRequestDto dto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] UpdateMedicationRequestDto dto)
        {
